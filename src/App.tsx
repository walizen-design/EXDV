    ...
    <div className={`min-h-screen transition-colors duration-300 bg-brand-bg text-brand-text selection:bg-brand-cyan/30 selection:text-white font-sans relative overflow-x-hidden`}>
      ...
      <header className={`sticky top-0 z-50 backdrop-blur-md border-b transition-all duration-300 py-4 px-6 md:px-12 flex justify-between items-center ${
        ...
        <div className="flex items-center gap-3">
          <svg className="w-8 h-8 text-brand-cyan fill-current animate-pulse" viewBox="0 0 68 40" aria-hidden="true">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              {/* Miniature racing stripes */}
              <div className="flex gap-0.5 h-3.5 items-center skew-x-12 select-none">
                <span className="w-1 h-full bg-[#00f0ff] rounded-xs" />
                <span className="w-1 h-full bg-[#1d4ed8] rounded-xs" />
                <span className="w-1 h-full bg-[#ef4444] rounded-xs" />
              </div>
            </div>
      ...
      >
        ...
        {/* Iconic Racing Accent Stripes (Light Blue, Dark Blue, Red) mimicking BMW M performance style */}
        <div className="absolute right-0 top-0 bottom-0 w-[45%] opacity-20 pointer-events-none overflow-hidden z-0 hidden lg:block select-none">
          <div className="absolute inset-0 flex transform -skew-x-[22deg] translate-x-[25%] scale-y-125">
            <div className="w-16 h-full bg-[#00f0ff] blur-md" />
            <div className="w-16 h-full bg-[#1d4ed8] blur-md" />
            <div className="w-16 h-full bg-[#ef4444] blur-md" />
          </div>
          <div className={`absolute inset-0 ${isDarkMode ? "bg-gradient-to-t from-[#090e1a] via-transparent to-[#090e1a]" : "bg-gradient-to-t from-[#f5f7fa] via-transparent to-[#f5f7fa]"}`} />
          <div className={`absolute inset-0 ${isDarkMode ? "bg-gradient-to-l from-transparent to-[#090e1a]" : "bg-gradient-to-l from-transparent to-[#f5f7fa]"}`} />
        </div>
      ...
      <section id="flagship-metrics" className="py-16 px-6 md:px-12 max-w-7xl mx-auto z-10 relative">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className={`border rounded-2xl p-6 relative overflow-hidden group hover:border-brand-cyan/20 transition-all duration-300 ${
            ...
            {/* 3-stripe sport accent */}
            <div className="absolute top-0 left-0 right-0 h-[3px] flex opacity-85">
